    ...
    return (
        <Modal isOpen={true} onClose={props.onClose} title="Configure Progress Bars">
            <div className="flex flex-col gap-4 md:gap-6">
                ...
                <button onClick={props.addBar} className="w-full py-2 md:py-3 border-2 border-dashed border-slate-300 dark:border-white/10 rounded-lg md:rounded-xl text-slate-500 hover:text-blue-500 hover:border-blue-500 hover:bg-blue-500/5 transition-all font-bold text-[10px] md:text-xs flex items-center justify-center gap-2">
                    + Add New Progress Bar
                </button>
                <div className="flex justify-end gap-2 md:gap-3 pt-1 md:pt-2 border-t border-slate-200 dark:border-white/10">
